...
| Repository | Short description | Status | Last visible update | Notes / next step |
|---|---|---|---|---|
| _None listed yet_ | Repositories will be moved here after cleanup and visibility review. | — | — | Current candidates: `FixaDataAutoboxar`, `LaczTabeleNietoperzy`, `CVC_Bats_Thermal_detection`, and possibly parts of `Artportalen_med_data`, depending on cleanup and visibility decisions. |
...
1. [CVC_Bats_Thermal_detection](https://github.com/JakubPelka/CVC_Bats_Thermal_detection) — add README, clarify scope, remove/ignore raw videos and generated outputs, check repository size, and decide whether it should stay public.
...
7. [GTB_connectivity](https://github.com/JakubPelka/GTB_connectivity) — validate QGIS Processing plugin structure, ignore working GIS data/outputs, document workflow limits, and prepare safe sample-data guidance.
...
8. [CVC_Bats_Thermal_detection](https://github.com/JakubPelka/CVC_Bats_Thermal_detection) — promising future CVC module, but first needs repository hygiene, sample-data policy, and privacy review.
